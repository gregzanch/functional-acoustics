...
import triangleArea from '../util/area.js';
import { meshVolume } from '../util/volume';
...
export const ParseOBJ = (obj) => new OBJFile(obj).parse();
export const ParseOBJ_dom = ({ element, loaded, error } = {}) => {
    readTextFile({
        element,
        loaded: e => {
