...
function drag() {
    ...
    function mousemoved() {
        noevent();
        if (!mousemoving) {
            var dx = d3.event.clientX - mousedownx,
                dy = d3.event.clientY - mousedowny;
...
function brush$1(dim) {
    ...
    function started() {
        if (d3.event.touches) {
            if (d3.event.changedTouches.length < d3.event.touches.length) return noevent$1();
...
function zoom() {
    ...
    function mousedowned() {
        ...
        function mousemoved() {
            noevent$2();
            if (!g.moved) {
                var dx = d3.event.clientX - x0,
                    dy = d3.event.clientY - y0;
